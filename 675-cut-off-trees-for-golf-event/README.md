<h2><a href="https://leetcode.com/problems/cut-off-trees-for-golf-event">Cut Off Trees for Golf Event</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are asked to cut off all the trees in a forest for a golf event. The forest is represented as an <code>m x n</code> matrix. In this matrix:</p>
